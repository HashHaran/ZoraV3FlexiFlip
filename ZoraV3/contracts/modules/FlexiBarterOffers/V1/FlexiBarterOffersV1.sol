...
import {UniversalFlexiBarterExchangeEventV1} from "../../../common/UniversalFlexiBarterExchangeEvent/V1/UniversalFlexiBarterExchangeEventV1.sol";
...
contract FlexiBarterOffersV1 is
    ReentrancyGuard,
    UniversalFlexiBarterExchangeEventV1,
    ...
    ModuleNamingSupportV1
{
    ...
    constructor(
        ...
        OutgoingNftTransferSupportV1()
        ModuleNamingSupportV1("Flexi Barter Offers: v1.0")
    {}
    ...
    /// @param _offerTokenContract The NFT collection contract address
    /// @param _offerTokenId The NFT token id of the offered NFT
    ...
    function createOffer(
        ...
        offers[_tokenContract][_tokenId][offerCount] = Offer({
            ...
            amount: _amount,
            nft: _offerTokenContract,
            tokenId: _offerTokenId
        });
    ...
    function fillOffer(
        ...
        require(offer.nft == _offerTokenContract && offer.tokenId == _offerTokenId, "fillOffer _offerTokenContract & _offerTokenId must match offer");
        ...
        // Transfer offered NFT offer taker
        ...
        FlexiBarterExchangeDetails memory userAExchangeDetails = FlexiBarterExchangeDetails({
            ...
            nftTokenContract: offer.nft,
            tokenId: offer.tokenId,
            amount: offer.amount
        });
        FlexiBarterExchangeDetails memory userBExchangeDetails = FlexiBarterExchangeDetails({
        ...
        emit FlexiBarterExchangeExecuted(offer.maker, msg.sender, userAExchangeDetails, userBExchangeDetails);
